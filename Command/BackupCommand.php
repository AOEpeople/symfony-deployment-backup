...
class BackupCommand extends ContainerAwareCommand {
    ...
    protected function configure() {
        $this
            ...
            ->addOption('backupSQLFilename', NULL, InputOption::VALUE_REQUIRED, 'SQL backup filename.', 'database.sql.gz')
            ->addOption('backupAssets', NULL, InputOption::VALUE_NONE, 'Create Assets backup.')
            ->addOption('backupAssetsFilename', NULL, InputOption::VALUE_REQUIRED, 'Assets backup filename.', 'assets.tar.gz')
